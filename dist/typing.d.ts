...
export declare type IntervalItem = {
    id: number;
    name: string;
    abbr?: string;
    color: string;
...
export declare type MarginOpts = {
    top?: number;
    bottom?: number;
    left?: number;
    right?: number;
...
export declare type NodeItem = HierarchyRectangularNode<IntervalItem> & {
    target?: {
        x0: number;
        x1: number;
        y0?: number;
...
export declare type d3ZoomEvent = {
